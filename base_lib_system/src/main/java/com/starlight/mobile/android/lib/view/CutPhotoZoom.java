 ...
 *
 */
public class CutPhotoZoom extends ImageView implements
		OnScaleGestureListener, OnTouchListener,
		ViewTreeObserver.OnGlobalLayoutListener

{

	private static final String TAG = CutPhotoZoom.class.getSimpleName();
	...
	public CutPhotoZoom(Context context)
	{
		this(context, null);
	}

	public CutPhotoZoom(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private class AutoScaleRunnable implements Runnable
	{
		...
		public void run()
		{
			...
			{
				CutPhotoZoom.this.postDelayed(this, 16);
			} else
			// 设置为目标的缩放比例
			{
	...
	public Bitmap clip()
	{
		...
		return Bitmap.createBitmap(bitmap, mHorizontalPadding,
				Math.max(mVerticalPadding,0), getWidth() - 2 * mHorizontalPadding,
