...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextUnSelectedColor = 0xFF666666;
...
//				}
	...
	private void switchTextColor(int position,boolean isSelected){
		try{
			View v = tabsContainer.getChildAt(position);
			if (v instanceof TextView) {
				TextView tab = (TextView) v;
				tab.setTextColor(isSelected?tabTextSelectedColor:tabTextUnSelectedColor);
			}
		}catch(Exception e){
			notifyDataSetChanged();
		}
