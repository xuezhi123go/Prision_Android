...
public class BubbleImageHelper {
    ...
    public Bitmap getBubbleImageBitmap(Bitmap srcBitmap,
         ...
         if (srcWidth < (float) CommonHelper.getImageMessageItemMinWidth(context)
                 && srcHeight < (float) CommonHelper
                         .getImageMessageItemMinHeight(context)) {
             srcWidth = CommonHelper.getImageMessageItemMinWidth(context);
             srcHeight = (float) CommonHelper
                     .getImageMessageItemMinHeight(context);
