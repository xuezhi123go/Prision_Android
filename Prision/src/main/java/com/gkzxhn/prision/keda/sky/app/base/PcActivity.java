...
package com.gkzxhn.prision.keda.sky.app.base;
...
import com.gkzxhn.prision.keda.utils.PcToastUtil;
...
public abstract class PcActivity extends ActionBarActivity implements PcIActivity {
	...
	/**
	 * @see android.content.ContextWrapper#registerReceiver(BroadcastReceiver, IntentFilter)
	 */
	@Override
	...
	/**
	 * @see android.content.ContextWrapper#unregisterReceiver(BroadcastReceiver)
	 */
	@Override
