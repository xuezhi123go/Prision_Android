...
public class CalendarCard extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if(onBackTextSize!=null)onBackTextSize.setTextSize(mCellSpace);
    }
    private OnBackTextSize onBackTextSize;

    public void setOnBackTextSize(OnBackTextSize onBackTextSize) {
        this.onBackTextSize = onBackTextSize;
    }

    public interface OnBackTextSize{
