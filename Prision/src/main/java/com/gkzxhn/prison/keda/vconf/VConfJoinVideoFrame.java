...
public class VConfJoinVideoFrame extends Fragment implements View.OnClickListener {
	...
	/**
	 * 
	 * @see com.pc.app.v4fragment.PcAbsFragment#onCreateView(LayoutInflater, ViewGroup, Bundle)
	 */
	@Override
	...
	/**
	 * @see com.pc.app.v4fragment.PcAbsFragment#onViewCreated(View, Bundle)
	 */
	@Override
	...
	public void initComponentValue() {
		...
		if (mVConfVideoUI.ismIsP2PConf()) {
			mVConfVideoUI.setmConfTitle(mVConfVideoUI.getmConfTitle());
		}
